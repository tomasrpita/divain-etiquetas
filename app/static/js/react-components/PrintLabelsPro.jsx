...
export const PrintLabelsPro = () => {
  ...
  React.useEffect(() => {
    if (data && data.production_order_id) {
      ...
      iptControl.current.setAttribute(
        "placeholder",
        "Ingrese EAN128 de la botella"
      );
  ...
  const handleKeyDown = (e) => {
    if (e.key === "Enter") {
      ...
      if (!drawer) {
        ...
        const currentBottle = ean13s.find(
          (ean13) => ean13 === getEan13(ean128)
        );
        ...
        if (currentBottle) {
          ...
          if (bottlesChecked + 1 === bottles) {
            iptControl.current.setAttribute(
              "placeholder",
              "Confirme gaveta para imprimir etiquetas "
            );
          }
        } else {
        ...
        const body = {
          ...
          ean13_ean128_dict: ean13Ean128Map,
        };
        setFetchBody(body);
        setFetchMethod("POST");
    ...
    <>
      <div className="form-group row">
        ...
        <div className="col-7">
          ...
          />
          {error && (
            <small id="smallControl" className="form-text text-danger ">
              {error}
            </small>
          )}
        </div>
        ...
        <div className="col-7">
          <div className="form-check form-check-inline">
            <input
              ...
              id="ue"
              value="UE"
              checked={labelDestination === "UE"}
              onChange={(e) => setLabelDestination(e.target.value)}
            />
            <label className="form-check-label" htmlFor="ue">
              UE
            </label>
          </div>
          <div className="form-check form-check-inline">
          ...
          <div className="form-check form-check-inline">
            <input
              ...
              id="mx"
              value="MX"
              checked={labelDestination === "MX"}
              onChange={(e) => setLabelDestination(e.target.value)}
            />
            <label className="form-check-label" htmlFor="mx">
              MX
            </label>
          </div>
        </div>
      ...
      <div className="form-group row">
        <div className="col-3">
          <label className="col-form-label">EANs13:</label>
        </div>
        <div className="col-7">
          <textarea
            className="form-control"
      ...
      <div className="form-group row">
        <div className="col-3">
          <label className="col-form-label">EANs128:</label>
        </div>
        <div className="col-7">
          <textarea
            className="form-control"
